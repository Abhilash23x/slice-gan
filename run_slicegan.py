...
Project_dir = 'C:/Users/ABHI/Desktop/project/SliceGAN'
...
if Training:
    ...
    img, raw, netG = util.test_img(Project_path, image_type, netG(), z_channels, lf=4) #Edit removed show=False, from the test_img()
